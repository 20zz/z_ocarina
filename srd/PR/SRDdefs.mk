#
# $Id: SRDdefs.mk,v 1.1.1.1 2003/01/17 21:06:42 tong Exp $
# 
...
# ディレクトリの設定
#
COMMON_DIR = $(ROOT)/usr/local/srd/PR
COMMON_INCDIR = $(COMMON_DIR)
COMMON_LIBDIR = $(COMMON_DIR)

PATCH_DIR = 	$(ROOT)/usr/local/srd/PR/patch/PR
...
#ifdef FORCE_CPP
.c.o :
	@echo $(CXX) '$$(CXXFLAGS) -Dthis=_this -c' $(.IMPSRC)
	@$(CXX) $(CXXFLAGS) -Dthis=_this -c $(.IMPSRC)
.c.s :
	@echo $(CXX) '$$(CXXFLAGS) -Dthis=_this -S -c' $(.IMPSRC)
	@$(CXX) $(CXXFLAGS) -Dthis=_this -c -S $(.IMPSRC)
.c.i :
	$(CXX) $(CXXFLAGS) -Dthis=_this -E $(.IMPSRC) > $(.PREFIX).i
#else
.c.o :
	@echo $(CC) '$$(CFLAGS) -c' $(.IMPSRC)
	@$(CC) $(CFLAGS) -c $(.IMPSRC)
.c.s :
	@echo $(CC) '$$(CFLAGS) -S -c' $(.IMPSRC)
	@$(CC) $(CFLAGS) -S -c $(.IMPSRC)
.c.i :
	$(CC) $(CFLAGS) -Dthis=_this -E $(.IMPSRC) > $(.PREFIX).i
#endif
.cxx.o .C.o .c++.o :
	@echo $(CXX) '$$(CXXFLAGS) -c' $(.IMPSRC)
